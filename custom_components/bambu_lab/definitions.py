...
PRINTER_SENSORS: tuple[BambuLabSensorEntityDescription, ...] = (
    ...
    BambuLabSensorEntityDescription(
        key="mounted_nozzle_r_filament_type",
        translation_key="mounted_nozzle_r_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.mounted_nozzle_r_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="mounted_nozzle_r_type",
        translation_key="mounted_nozzle_r_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.mounted_nozzle_r_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="mounted_nozzle_r_diameter",
        translation_key="mounted_nozzle_r_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.mounted_nozzle_r_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="mounted_nozzle_l_filament_type",
        translation_key="mounted_nozzle_l_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.mounted_nozzle_l_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="mounted_nozzle_l_type",
        translation_key="mounted_nozzle_l_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.mounted_nozzle_l_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="mounted_nozzle_l_diameter",
        translation_key="mounted_nozzle_l_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.mounted_nozzle_l_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_1_filament_type",
        translation_key="right_nozzle_1_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_1_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_1_type",
        translation_key="right_nozzle_1_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_1_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_1_diameter",
        translation_key="right_nozzle_1_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_1_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_2_filament_type",
        translation_key="right_nozzle_2_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_2_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_2_type",
        translation_key="right_nozzle_2_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_2_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_2_diameter",
        translation_key="right_nozzle_2_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_2_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_3_filament_type",
        translation_key="right_nozzle_3_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_3_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_3_type",
        translation_key="right_nozzle_3_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_3_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_3_diameter",
        translation_key="right_nozzle_3_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_3_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_4_filament_type",
        translation_key="right_nozzle_4_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_4_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_4_type",
        translation_key="right_nozzle_4_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_4_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_4_diameter",
        translation_key="right_nozzle_4_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_4_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_5_filament_type",
        translation_key="right_nozzle_5_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_5_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_5_type",
        translation_key="right_nozzle_5_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_5_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_5_diameter",
        translation_key="right_nozzle_5_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_5_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_6_filament_type",
        translation_key="right_nozzle_6_filament_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_6_filament_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_6_type",
        translation_key="right_nozzle_6_type",
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_6_type,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="right_nozzle_6_diameter",
        translation_key="right_nozzle_6_diameter",
        native_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_unit_of_measurement=UnitOfLength.MILLIMETERS,
        suggested_display_precision=1,
        device_class=SensorDeviceClass.DISTANCE,
        icon="mdi:printer-3d-nozzle",
        value_fn=lambda self: self.coordinator.get_model().info.right_nozzle_6_diameter,
        exists_fn=lambda coordinator: coordinator.get_model().supports_feature(Features.NOZZLE_RACK),
    ),
    BambuLabSensorEntityDescription(
        key="ip_address",
